...
時基的意義是「每一個 timestamp 單位代表多少秒」。

如果有安裝 ffmpeg，可以嘗試對一個影片進行

- `ffplay -vf "settb=AVTB*2,setpts=PTS" input.mp4` : 2倍時基撥放
- `ffplay -vf "settb=AVTB/2,setpts=PTS" input.mp4` : 0.5倍時基撥放
